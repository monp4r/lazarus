      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            <a href="IndexController.php?action=index"
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        <div x-data="Components.menu({ open: false })" x-init="init()"
          ...
          <div x-show="open" x-transition:enter="transition ease-out duration-100"
            ...
            class="block px-4 py-2 text-sm text-gray-700" x-state:on="Active" x-state:off="Not Active"
              ...
              @click="open = false; focusButton()">Tu Perfil</a>

            <a href="UsersController.php?action=edit_profile"
            
            class="block px-4 py-2 text-sm text-gray-700" :class="{ 'bg-gray-100': activeIndex === 1 }"
              ...
              @click="open = false; focusButton()">Gestionar Perfil</a>
            ...
            <a href="UsersController.php?action=logout" class="block px-4 py-2 text-sm text-gray-700"
              ...
              @click="open = false; focusButton()">Cerrar Sesión</a>
          </div>
        </div>
      </div>
    </div>
